...
impl From<u16> for ErrorKind {
    fn from(x: u16) -> Self {
        match x {
            ...
            3572_u16 => ErrorKind::ER_LOCK_NOWAIT,
            3819_u16 => ErrorKind::ER_CHECK_CONSTRAINT_VIOLATED,
...
impl ErrorKind {
    ...
    pub fn sqlstate(self) -> &'static [u8; 5] {
        match self {
            ErrorKind::ER_SIGNAL_EXCEPTION => b"45000",
            ErrorKind::ER_LOCK_NOWAIT | ErrorKind::ER_CHECK_CONSTRAINT_VIOLATED => b"HY000",
