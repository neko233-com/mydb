...
| `SELECT` 谓词/聚合/`DISTINCT`/`COUNT(DISTINCT)` | ✅ Verified | 支持多列/表达式 `COUNT(DISTINCT ...)`，按 MySQL 元组 NULL 规则和各表达式排序规则去重 |
