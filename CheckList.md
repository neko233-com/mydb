...
- [x] 2026-08-14 同机持久化基准（`eeaca1e`）：MyDB 与 MySQL 8.4.11 使用相同 Docker 资源和持久化设置；性能阶段无预热、22.5/60 秒、1 次采样，单表写 207/78 ops/s、4 actor P99 36.7/93.4 ms、并发吞吐 296/152 ops/s、读 P50 388/137 μs；原始结果见 `性能报告.md`，不硬编码历史比值
