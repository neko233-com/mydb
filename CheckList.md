...
- [x] 2026-08-15 v0.1.23 索引点查优化后同机持久化基准：MyDB 与 MySQL 8.4.11 使用相同 Docker 资源和持久化设置；性能阶段无预热、21.9/60 秒、1 次采样，单表写 222/80 ops/s、4 actor P99 34.4/64.5 ms、并发吞吐 297/156 ops/s、读 P50 395/134 μs；原始结果见 `性能报告.md`，不硬编码历史比值
