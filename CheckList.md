...
- [x] 2026-08-15 v0.1.22 索引点查优化（提交 8b25ac4）后同机持久化基准：MyDB 与 MySQL 8.4.11 使用相同 Docker 资源和持久化设置；性能阶段无预热、21.6/60 秒、1 次采样，单表写 216/80 ops/s、4 actor P99 29.5/50.5 ms、并发吞吐 329/155 ops/s、读 P50 323/127 μs；原始结果见 `性能报告.md`，不硬编码历史比值
