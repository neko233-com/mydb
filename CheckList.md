...
- [x] 2026-08-15 同机持久化基准（当前发布候选）：MyDB 与 MySQL 8.4.11 使用相同 Docker 资源和持久化设置；性能阶段无预热、21.6/60 秒、1 次采样，单表写 217/80 ops/s、4 actor P99 38.1/53.8 ms、并发吞吐 337/152 ops/s、读 P50 407/128 μs；原始结果见 `性能报告.md`，不硬编码历史比值
