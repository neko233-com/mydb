...
- [x] 2026-08-14 同机持久化基准：MyDB 与 MySQL 8.4.11 使用相同 Docker 资源和持久化设置；性能阶段无预热、22.5/60 秒、1 次采样，单表写 206/76 ops/s、4 actor P99 73.0/62.8 ms、并发吞吐 285/145 ops/s、读 P50 269/128 μs；原始结果见 `性能报告.md`，不硬编码历史比值
