...
- [x] 2026-08-15 同机持久化基准（当前发布候选）：MyDB 与 MySQL 8.4.11 使用相同 Docker 资源和持久化设置；性能阶段无预热、22.6/60 秒、1 次采样，单表写 209/75 ops/s、4 actor P99 43.0/77.1 ms、并发吞吐 267/159 ops/s、读 P50 264/136 μs；原始结果见 `性能报告.md`，不硬编码历史比值
