...
- [x] 2026-08-14 同机持久化基准：MyDB 与 MySQL 8.4.11 使用相同 Docker 资源和持久化设置；性能阶段无预热、1 次采样、60 秒硬截止，单表写 221/80 ops/s、4 actor P99 35.1/83.8 ms、并发吞吐 264/147 ops/s、读 P50 404/134 μs；原始结果见 `性能报告.md`，不硬编码历史比值
