...
- [x] 2026-08-15 同机持久化基准（提交 `277a2ae`）：MyDB 与 MySQL 8.4.11 使用相同 Docker 资源和持久化设置；性能阶段无预热、22.4/60 秒、1 次采样，单表写 209/75 ops/s、4 actor P99 43.4/53.3 ms、并发吞吐 287/148 ops/s、读 P50 394/141 μs；原始结果见 `性能报告.md`，不硬编码历史比值
