...
- [x] 2026-08-14 同机持久化基准：MyDB release 13307 vs MySQL 8.4.11 3306，3 次中位数；单表写 207/66 ops/s、P99 29.9/74.2 ms、并发吞吐 1290/964 ops/s、读 P50 353/631 μs；原始结果见 `性能报告.md`，不硬编码历史比值
