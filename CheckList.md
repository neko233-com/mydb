...
- [x] 2026-08-15 v0.1.22 更新器修复后同机持久化基准：MyDB 与 MySQL 8.4.11 使用相同 Docker 资源和持久化设置；性能阶段无预热、22.9/60 秒、1 次采样，单表写 216/81 ops/s、4 actor P99 28.8/49.0 ms、并发吞吐 319/122 ops/s、读 P50 415/138 μs；原始结果见 `性能报告.md`，不硬编码历史比值
