...
- [x] 2026-08-14 当前 release 真实 MySQL 8.4 差分：同机 Docker `mysql:8.4` 与隔离 MyDB 对比，103/103 cases 通过；含 JSON 路径/重叠、BIT 聚合、常量聚合投影、全文 TF-IDF 基础评分/布尔前缀与短语、未知线程 KILL 错误、角色授权、ai_ci、EXPLAIN、状态接口、生成列 INSERT/UPDATE/UPSERT/INSERT SELECT 显式写入错误码/消息；物理 3306 服务未强制替换
