...
|------|------|--------------|--------------|
| 单表写（fsync-per-commit） | 206 ops/s | 80 ops/s | 2.58x |
| 4 actor / 4表 写 P99 延迟 | 22.8 ms | 57.6 ms | 2.53x（低更好） |
| 4 actor / 4表 Group Commit | 286 ops/s | 146 ops/s | 1.97x |
| 读 P50 延迟 | 361 μs | 130 μs | - |
