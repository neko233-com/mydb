...
.\scripts\build-release.ps1 -Version "0.1.32"
...
- ✅ v0.1.32 同条件持久化基准：无预热、22.8/60 秒、1 次采样；单表写 206/74 ops/s、4 actor P99 37.5/67.6 ms、并发吞吐 279/140 ops/s、读 P50 265/129 μs；源码提交 `37af36d`，原始结果见 [性能报告.md](性能报告.md)
