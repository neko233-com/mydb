...
|------|------|--------------|--------------|
| 单表写（fsync-per-commit） | 205 ops/s | 80 ops/s | 2.58x |
| 4 actor / 4表 写 P99 延迟 | 28.5 ms | 57.4 ms | 2.01x（低更好） |
| 4 actor / 4表 Group Commit | 280 ops/s | 149 ops/s | 1.88x |
| 读 P50 延迟 | 334 μs | 141 μs | - |
