...
|------|------|--------------|--------------|
| 单表写（fsync-per-commit） | 214 ops/s | 78 ops/s | 2.75x |
| 4 actor / 4表 写 P99 延迟 | 49.9 ms | 49.7 ms | 1.00x（低更好） |
| 4 actor / 4表 Group Commit | 335 ops/s | 148 ops/s | 2.27x |
| 读 P50 延迟 | 462 μs | 129 μs | - |
